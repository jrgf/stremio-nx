...
export interface MemoryUsage {
	...
	/** Reserved address space for the Switch V8 data arena, in bytes. */
	dataArenaSize: number;
	/** Data arena pages currently reserved by V8, in bytes. */
	dataArenaUsed: number;
	/** Retained backing slabs for the data arena, in bytes. */
	dataArenaCommitted: number;
}
